...
class MetricsPersistence:
    """Handles saving and loading metrics from PostgreSQL using connection pooling."""
    ...
    def _get_conn(self):
        if self._injected_conn:
            ...
            return nullcontext(self._injected_conn)
    ...
    def close(self):
        """No longer needed with pool but kept for compatibility."""
        pass
